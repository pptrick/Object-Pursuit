...
dir_checkpoint = f'checkpoints_davis_{obj}_coeff_50base'
...
def train_net(args,
    ...
    # oneshot_dataset = OneshotDavisDataset('/data/pancy/Davis/DAVIS-2017-trainval-480p/DAVIS', 'blackswan', resize=(256, 256))
