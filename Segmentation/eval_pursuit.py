...
if __name__ == "__main__":
    ...
    net.init_hypernet('./checkpoints_sequence_threshold_0.7/checkpoint/hypernet.pth')
    net.init_backbone('./checkpoints_sequence_threshold_0.7/checkpoint/backbone.pth')
