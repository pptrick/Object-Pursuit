...
if __name__ == "__main__":
    checkpoint_path = './checkpoints_equal_small/checkpoint.pth'
    ...
    net = Multinet(obj_num=len(obj_map), z_dim=50, device=device)
    ...
    # torch.save(net.state_dict(),'./checkpoints/checkpoint_test.pth')
